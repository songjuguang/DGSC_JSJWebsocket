...
public class DefaultWebSocketClientFactoryss implements WebSocketClientss.WebSocketClientFactory {
    private final WebSocketClientss webSocketClient;

    public DefaultWebSocketClientFactoryss(WebSocketClientss webSocketClient) {
